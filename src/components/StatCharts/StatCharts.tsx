...
const StatCharts: React.FC<IProps> = ({ blocks, victoryTheme }) => {
  ...
  return (
    <Grid className="statCharts" spacing={4} justify="space-between" item container>
      <Grid className={setClass} key="hashChart" item xs={12} md={6} lg={3}>
      ...
      <Grid className={setClass} key="txChart" item xs={12} md={6} lg={3}>
      ...
      <Grid className={setClass} key="gasUsed" item xs={12} md={6} lg={3}>
      ...
      <Grid className={setClass} key="uncles" item xs={12} md={6} lg={3}>
